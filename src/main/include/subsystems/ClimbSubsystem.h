...
class ClimbSubsystem : public frc2::SubsystemBase {
 public:
  ...
  [[nodiscard]] frc2::CommandPtr SetSyncBehaviorCMD(Behavior behavior);
  [[nodiscard]] frc2::CommandPtr SetSyncTargetCMD(units::meter_t target);
  [[nodiscard]] frc2::CommandPtr SetLeftTargetCMD(units::meter_t target);
  [[nodiscard]] frc2::CommandPtr SetRightTargetCMD(units::meter_t target);
