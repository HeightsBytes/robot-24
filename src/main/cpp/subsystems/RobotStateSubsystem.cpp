...
RobotStateSubsystem::RobotStateSubsystem(ArmSubsystem* arm, ShooterSubsystem* shooter) : m_arm(arm), m_shooter(shooter) {}
...
void RobotStateSubsystem::InitSendable(wpi::SendableBuilder& builder) {
    ...
    builder.AddStringProperty("Scoring State", [this] {return ToStr(m_state);}, nullptr);
